Volt.configure do |config|
  ...
  #######################################
  config.domain = 'some-project.com'
  config.app_name = 'Some_project'
  config.mailer.from = 'Some_project <no-reply@some-project.com>'
  ...
  #
  config.app_secret = 'yp4xudllePayKyzkq3G3eODSs_Nrst8jMl-8yIOKaA-_AOnOtfwedCwip8UUxwvrPqc'
